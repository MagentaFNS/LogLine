        ...
        {showUserMenu && (
          <div className="bg-white rounded-xl p-2 space-y-1 mb-2 shadow-2xl border border-gray-100 animate-fadeIn">
            <button
              ...
              className="w-full text-left px-3 py-2 text-sm font-medium text-black hover:bg-gray-50 rounded-lg flex items-center gap-2 transition-all"
            >
            ...
            <button
              onClick={logout}
              className="w-full text-left px-3 py-2 text-sm font-bold text-black hover:bg-gray-50 rounded-lg flex items-center gap-2 transition-all"
            >
